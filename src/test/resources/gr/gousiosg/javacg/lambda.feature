...
Feature: Lambda
  ...
  Scenario: Retrieve lambda in method
    ...
    Then the result should contain:
      """
      M:LambdaTest:methodA() Runner:run(LambdaTest)
      """
    # Call of methodB in r
    And the result should contain:
      """
      M:LambdaTest:lambda$methodA$0() LambdaTest:methodB()
      """
  ...
  Scenario: Retrieve nested lambdas
    ...
    Then the result should contain:
      """
      M:NestedLambdaTest:methodA() Runner:run(NestedLambdaTest)
      """
    # Creation of r2 in r
    And the result should contain:
      """
      M:NestedLambdaTest:lambda$methodA$2() Runner:run(NestedLambdaTest)
      """
    # Creation of r3 in r2
    And the result should contain:
      """
      M:NestedLambdaTest:lambda$lambda$methodA$2$1() Runner:run(NestedLambdaTest)
      """
    # Call of methodB in r3
    And the result should contain:
      """
      M:NestedLambdaTest:lambda$lambda$lambda$methodA$2$1$0() NestedLambdaTest:methodB()
      """
